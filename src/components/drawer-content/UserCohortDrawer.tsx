...
export default function UserCohortDrawer({handleClose}: UserCohortDrawerProps) {
  ...
  const [data, setData] = useState({});
    const {
      ...
      defaultValues: {
        ...
        age: "", // or "tech" or any default value
        gender:"",
      },
  ...
  const handleConfirm = () =>{
    ...
    return (
      <Box>
        ...
        <GlobalDialog
          open={openSave}
          handleClose={() => {setSaveDialog(false); setData({});}}
          component={
            <CommonDialog
              title="Save Cohort"
              subTitle="Are you sure want to save this cohort?"
              handleCancel={() => {setSaveDialog(false); setData({});}}
